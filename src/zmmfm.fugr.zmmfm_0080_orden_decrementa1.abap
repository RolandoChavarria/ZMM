FUNCTION ZMMFM_0080_ORDEN_DECREMENTA1.
*"----------------------------------------------------------------------
*"*"Interfase local
*"  IMPORTING
...
* Generear orde decrmenta
  ...
  PERFORM f_reg_log_conexion2 USING 'ZMMFM_0080_ORDEN_DECREMENTA1' i_vendor
  ...
  PERFORM main_decrementa_serv USING i_vendor i_pur_grp i_proyect i_folio
                     T_AZULES I_TEST
